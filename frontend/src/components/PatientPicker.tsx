    ...
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          autoFocus={autoFocus}
          autoComplete="off"
          className={`w-full rounded-lg border border-slate-300 py-2 pl-9 pr-9 text-sm transition-smooth focus:border-brand-600 focus:outline-none focus:ring-1 focus:ring-brand-600 ${inputClassName}`}
        />
        {loading && (
