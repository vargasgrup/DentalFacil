  ...
  return (
    <label className={`block ${className}`}>
      ...
      <select
        ...
        className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm transition-smooth focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
      >
